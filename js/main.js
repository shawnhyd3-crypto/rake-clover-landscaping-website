...
` +
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                showNotification('Thank you! Your message has been sent. Jon will get back to you soon.', 'success');
                contactForm.reset();
            } else {
    ...
    const galleryItems = document.querySelectorAll('.gallery-item img, .gallery-item .image-placeholder');
